            ...
            SubCommand::with_name("airdrop")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The airdrop amount to request, in OBTT"),
                )
                .arg(
            ...
            SubCommand::with_name("deploy")
                ...
                .arg(
                    Arg::with_name("allow_excessive_balance")
                        ...
                        .takes_value(false)
                        .help("Use the designated program id, even if the account already holds a large balance of OBTT")
                ),
        )
        .subcommand(
            ...
            SubCommand::with_name("transfer")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help("The amount to send, in OBTT; accepts keyword ALL"),
                )
                .arg(
                    pubkey!(Arg::with_name("from")
                        .long("from")
