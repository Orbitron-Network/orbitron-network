            ...
            SubCommand::with_name("withdraw-from-vote-account")
                ...
                .arg(
                    pubkey!(Arg::with_name("destination_account_pubkey")
                        ...
                        .required(true),
                        "The recipient of withdrawn OBTT. "),
                )
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help("The amount to withdraw, in OBTT; accepts keyword ALL, which for this command means account balance minus rent-exempt minimum"),
                )
                .arg(
                    Arg::with_name("authorized_withdrawer")
                        .long("authorized-withdrawer")
