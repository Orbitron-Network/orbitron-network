...
pub enum RpcRequest {
    ...
    /// Orbitron Account scope
    GetOrbitronAccountsByOperationalKey,
    GetOrbitronAccountsByOwnerKey,
    GetOrbitronRelyingPartiesByOwnerKey,
...
impl fmt::Display for RpcRequest {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let method = match self {
            ...
            RpcRequest::GetOrbitronAccountsByOperationalKey => "getOrbitronAccountsByOperationalKey",
            RpcRequest::GetOrbitronAccountsByOwnerKey => "getOrbitronAccountsByOwnerKey",
            RpcRequest::GetOrbitronRelyingPartiesByOwnerKey => "getOrbitronRelyingPartiesByOwnerKey",
