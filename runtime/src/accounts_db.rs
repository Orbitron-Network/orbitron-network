...
impl AccountsDb {
        ...
        A: Default,
    {
        let key = match &index_key {
            ...
            IndexKey::OrbitronAccountStorage(key) => key,
            IndexKey::OrbitronAccountOwner(key) => key,
            IndexKey::OrbitronAccountOperational(key) => key,
            IndexKey::OrbitronRelyingOwner(key) => key,
        };
