...
impl DerivationPath {
    ...
    pub fn from_key_str(path: &str) -> Result<Self, DerivationPathError> {
        Self::from_key_str_with_coin(path, Orbitron)
    }
    ...
    pub fn new_bip44(account: Option<u32>, change: Option<u32>) -> Self {
        Self::new_bip44_with_coin(Orbitron, account, change)
    }
    ...
    fn from_uri(
        ...
        if let Some(query) = uri.query() {
            ...
            if let Some(key) = key {
                ...
                // generates a Orbitron bip44 DerivationPath
