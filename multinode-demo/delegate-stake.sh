...
function get_token_capitalization {
    ...
    totalSupplySol=$((totalSupplyLamports / LAMPORTS_PER_OBTT))
...
totalAccountBalancesSol=$((totalAccountBalancesLamports / LAMPORTS_PER_OBTT))
...
printf "Total OBTT in all Account Balances: %'d\n" "$grandTotalAccountBalancesSol"
