...
pub fn main() {
    ...
    let matches = App::new(crate_name!()).about(crate_description!())
        ...
        .arg(
            Arg::with_name("evm_state_rpc_port")
                ...
                .validator(orbitron_validator::port_validator)
        ...
        .arg(
            Arg::with_name("dynamic_port_range")
                ...
                .validator(orbitron_validator::port_range_validator)
        ...
        .arg(
            Arg::with_name("account_indexes")
                ...
                .possible_values(&[
                    ...
                    "spl-token-owner",
                    "spl-token-mint",
                    "orbitron-accounts-storages",
                    "orbitron-accounts-owners",
                    "orbitron-accounts-operationals",
                    "orbitron-relying-party-owners",
                ])
                .value_name("INDEX")
    ...
    let logfile = {
        let logfile = matches
            .value_of("logfile")
            .map(|s| s.into())
            .unwrap_or_else(|| format!("orbitron-validator-{}.log", identity_keypair.pubkey()));
...
fn process_account_indexes(matches: &ArgMatches) -> AccountSecondaryIndexes {
    let account_indexes: HashSet<AccountIndex> = matches
        ...
        .map(|value| match value {
            ...
            "orbitron-accounts-storages" => AccountIndex::OrbitronAccountStorage,
            "orbitron-accounts-owners" => AccountIndex::OrbitronAccountOwner,
            "orbitron-accounts-operationals" => AccountIndex::OrbitronAccountOperational,
            "orbitron-relying-party-owners" => AccountIndex::OrbitronRelyingOwner,
